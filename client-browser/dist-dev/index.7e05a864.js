...
})({"8ObMH":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "b3b58daa7e05a864";
"use strict";
...
},{"./main.scss":"2NwCl","./components/form-pessoa":"hHw2a"}],"2NwCl":[function() {},{}],"hHw2a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FormPessoa", ()=>FormPessoa
);
var _formPessoaScss = require("bundle-text:./form-pessoa.scss");
var _formPessoaScssDefault = parcelHelpers.interopDefault(_formPessoaScss);
var _formPessoaHtml = require("bundle-text:./form-pessoa.html");
var _formPessoaHtmlDefault = parcelHelpers.interopDefault(_formPessoaHtml);
class FormPessoa extends HTMLElement {
    ...
    _criarElementosPrincipais() {
        const style = document.createElement("style");
        const main = document.createElement("main");
        style.innerHTML = _formPessoaScssDefault.default;
        main.innerHTML = _formPessoaHtmlDefault.default;
        this._root.append(style, main);
        this._domMain = main;
        this._domActionBar = main.querySelector(".actions");
    }
    _referenciarBotoesEElementos() {
        this._domMain.querySelectorAll("input[name]").forEach((input)=>{
            this._inputs[input.getAttribute("name")] = input;
        });
        this._domMain.querySelectorAll("button[name]").forEach((button)=>{
            this._buttons[button.getAttribute("name")] = button;
        });
    }
    _atribuirEventos() {
    ...
    async _remover() {
        if (this._id) try {
            await fetch(`http://localhost:8080/pessoa/${this._id}`, {
                method: "DELETE"
            });
        } catch (e) {
            alert("ERRO: " + e);
    ...
    async _salvar() {
        const values = Object.fromEntries(Object.entries(this._inputs).map(([key, input])=>[
                key,
                input.value
            ]
        ));
...
},{}]},["8ObMH","1yGwE"], "1yGwE", "parcelRequire659d")

//# sourceMappingURL=index.7e05a864.js.map
